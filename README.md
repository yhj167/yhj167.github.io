...
###[git clone from Hux Blog &rarr;](http://huxpro.github.io)
...
The Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
